    ...
    return (
        <div className= "school-orgs">
            ...
            <div className="club-container">
                ...
                <ClubCard orgName ="Design & Code Club" desc="Where art meets code" image="https://designandcodeucf.com/assets/DesignCodeTriLogo-12f8a23e.png" />
                ...
                <ClubCard orgName ="Animation Production Club " desc="An animation community at UCF" image ="https://se-images.campuslabs.com/clink/images/9c4bd7d2-df9e-4de6-8dd6-dc3613a8f1a6c20e5ec9-feaa-4d6b-9a76-38fd478b5915.png?preset=med-sq" />
                ...
                <ClubCard orgName ="Society of PC Building at UCF" desc="An indepth club course for PC Building at UCF" image ="https://se-images.campuslabs.com/clink/images/99c0f67b-b28c-4237-a943-90078d7f4ee46634f305-21e7-4aa4-bc5b-1b937dc452a6.PNG?preset=med-sq"/>
                <ClubCard orgName ="Bsides" desc="An affliated cybersecurity community" image ="https://bsidesorlando.org/assets/images/logo-b.png" />
                <ClubCard orgName ="SWE UCF" desc="Society of Women Engineers at UCF" image ="https://se-images.campuslabs.com/clink/images/27c36c54-29e2-4107-836c-aba6355c0588615f270d-644d-4d2c-9135-89fc3cda6725.png?preset=med-sq" />
                <ClubCard orgName ="WEEC UCF" desc="Women in Electrical Engineers and Computer Science at UCF" image ="https://se-images.campuslabs.com/clink/images/62c4513a-992f-481b-bec2-394ea76b6f11cabcbce2-f5e0-44f8-8fa9-e796ad78db60.jpg?preset=med-sq" />
            </div>
